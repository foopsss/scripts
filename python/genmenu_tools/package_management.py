...
def draw_package_management_menu():
    ...
    print("10. Buscar el paquete que provee un comando específico.")
    print("11. Buscar el paquete que provee un archivo específico.")
    print("")
    print("FLATPAK")
    draw_coloured_line(7)
    print("12. Instalar una aplicación de Flatpak.")
    print("13. Remover una aplicación de Flatpak.")
    print("14. Remover dependencias sin uso.")
    print("")
    print("MISCELÁNEA")
    ...
    while True:
        ...
        match choice:
            case 1 | 2:
                ...
                print("")
            case 3 | 4 | 5 | 7 | 8 | 9 | 12 | 13:
                user_input = get_validated_input("Nombre del paquete: ")
                print("")
            case 10:
                user_input = get_validated_input("Comando: ")
                print("")
            case 11:
                user_input = get_validated_input("Archivo: ")
                print("")
        ...
        match choice:
            ...
            case 7:
                run_command(["equery", "depends", f"{user_input}"])
            case 8:
            ...
            case 9:
                run_command(["equery", "list", "-Ipo", f"{user_input}"])
            case 10:
                run_command(["equery", "b", f"{user_input}"])
            case 11:
                run_command(["equery", "belongs", f"{user_input}"])
            case 12:
